...
accelerate launch --config_file examples/wanvideo/model_training/full/accelerate_config_14B.yaml \
  ...
  --dataset_base_path "" \
  --dataset_metadata_path /mnt/bn/aicoding-lq/luhaotian/projects/DiffSynth-Studio/bin/data/metadata_hl/train_metadata.jsonl \
  --data_file_keys "video,control_video,reference_image,hl_npz" \
  --height 480 \
  --width 832 \
  --dataset_repeat 1 \
  --model_paths '[   
  ...
  --output_path "/mnt/bn/aicoding-lq/luhaotian/projects/DiffSynth-Studio/bin/experiments/hl/ckpt" \
  --lora_base_model "dit" \
  --lora_target_modules "q,k,v,o,ffn.0,ffn.2" \
  --lora_rank 32 \
  --extra_inputs "control_video,reference_image,hl_npz" \
  --hl_scale 0.1
